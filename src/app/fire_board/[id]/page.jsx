...
export default async function PostDetailsPage({params, searchParams}) {
  ...
  const shouldIncrementView = searchParams.justPosted !== 'true'; 
  ...
  return (
        <div className="FireBoard-Detail p-5 bg-white/70 FBOARD-border-1">
            <h1 className="text-xl md:text-3xl font-bold mb-4 border-b pb-2 border-igniteOrange-100">
            ...
            <div className="ContentBox whitespace-pre-wrap p-4 bg-igniteOrange-50/40 FBOARD-border-1">
                {post.content}
            </div>
            
            {/* 불씨 주기 버튼 UI */}
            <div className="flex justify-end items-center pr-4 mt-4 pb-4 gap-4 border-b-4 border-double border-amber-600/30">
