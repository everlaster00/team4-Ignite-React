...
export default function SidebarOfMemberNav() {
  ...
  return (
    <aside className="SideNav sticky left-0 top-0 flex flex-col bg-teal-300/80 overflow-hidden h-screen w-28 md:w-32 lg:w-38 px-2 lg:px-5 space-y-2 z-index-1 pb-195">
